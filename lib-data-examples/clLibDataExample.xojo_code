...
Protected Class clLibDataExample
	...
	#tag Method, Flags = &h0
		Function Example_034(log as LogMessageInterface, Describe as boolean, Description() as string) As clDataTable()
		  ...
		  var tjoin1 as clDataTable = tsales.FullJoin(tcountries1, JoinMode.InnerJoin, array("City"),"Join_status")
		  
		  var tjoin2 as clDataTable = tsales.FullJoin(tcountries1, JoinMode.OuterJoin, array("City"),"Join_status")
		  
		  var tjoin3 as clDataTable = tsales.FullJoin(tcountries2, JoinMode.InnerJoin, array("City"),"Join_status")
		  
		  var tjoin4 as clDataTable = tsales.FullJoin(tcountries2, JoinMode.OuterJoin, array("City"),"Join_status")
		  
		  var tjoin5 as clDataTable = tsales.FullJoin(tcountries3, JoinMode.InnerJoin, array("City"),"Join_status")
